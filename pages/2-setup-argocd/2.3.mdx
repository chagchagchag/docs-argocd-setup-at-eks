## 3. 80포트 허용된 ArgoCD 에 Ingress URL 을 통해 접속해보기
EC2 대시보드 → 로드밸런서 메뉴로 이동하면 아래와 같이 DNS 이름을 확인할 수 있다. 이 것을 복사한다.
![](https://raw.githubusercontent.com/chagchagchag/docs-argocd-setup-at-eks/main/pages/2-setup-argocd/img/2.3-CONNECT-TO-ARGOCD-BY-INGRESS-URL/1.png)
<br/>
...
![](https://raw.githubusercontent.com/chagchagchag/docs-argocd-setup-at-eks/main/pages/2-setup-argocd/img/2.3-CONNECT-TO-ARGOCD-BY-INGRESS-URL/2.png)
<br/>
