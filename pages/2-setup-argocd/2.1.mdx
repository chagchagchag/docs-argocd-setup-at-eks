...
aregocd 설치 명령어는 [argo-cd.readthedocs.io - getting started](https://argo-cd.readthedocs.io/en/stable/getting_started/) 에 자세하게 설명되어 있다.
...
그리고 설치된 argocd 는 아래와 같이 확인해보자<br/>
```bash filename="terminal" {3} copy
