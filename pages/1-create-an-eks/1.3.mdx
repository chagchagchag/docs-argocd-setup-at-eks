...
새로 생성 중인 노드를 확인해보면 아래와 같습니다.<br/>
![](https://raw.githubusercontent.com/chagchagchag/eks-k8s-docker-study-archive/main/eks-by-argocd/img/CLUSTER-SETUP-3-EKSCTL-MANAGED-NODEGROUP-DELETE/1.png)
